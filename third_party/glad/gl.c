...
static void glad_gl_load_GL_OVR_multiview(GLADuserptrloadfunc load, void* userptr) {
    ...
    glad_glNamedFramebufferTextureMultiviewOVR =
        (PFNGLNAMEDFRAMEBUFFERTEXTUREMULTIVIEWOVRPROC)load(userptr, "glNamedFramebufferTextureMultiviewOVR");
}
...
static int glad_gl_get_extensions(
    int version, const char** out_exts, unsigned int* out_num_exts_i, char*** out_exts_i) {
...
static int glad_gl_find_extensions_gl(int version) {
    ...
    GLAD_GL_EXT_framebuffer_blit_layers =
        glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_framebuffer_blit_layers");
    ...
    GLAD_GL_MESA_texture_const_bandwidth =
        glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_MESA_texture_const_bandwidth");
    ...
    GLAD_GL_NV_uniform_buffer_std430_layout =
        glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NV_uniform_buffer_std430_layout");
